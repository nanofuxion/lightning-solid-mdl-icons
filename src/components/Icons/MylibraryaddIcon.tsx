...
const MylibraryaddIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e02e', 16))}
    </Text>
  );
};

export default MylibraryaddIcon;
