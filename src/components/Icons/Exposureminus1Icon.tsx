...
const Exposureminus1Icon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e3cb', 16))}
    </Text>
  );
};

export default Exposureminus1Icon;
