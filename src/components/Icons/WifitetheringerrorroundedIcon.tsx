...
const WifitetheringerrorroundedIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('f086', 16))}
    </Text>
  );
};

export default WifitetheringerrorroundedIcon;
