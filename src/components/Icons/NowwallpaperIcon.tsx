...
const NowwallpaperIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e75f', 16))}
    </Text>
  );
};

export default NowwallpaperIcon;
