...
const Diversity1Icon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('f8d7', 16))}
    </Text>
  );
};

export default Diversity1Icon;
