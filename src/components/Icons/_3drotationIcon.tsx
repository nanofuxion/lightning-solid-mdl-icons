...
const _3drotationIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e84d', 16))}
    </Text>
  );
};

export default _3drotationIcon;
