...
const EnhancephototranslateIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e8fc', 16))}
    </Text>
  );
};

export default EnhancephototranslateIcon;
