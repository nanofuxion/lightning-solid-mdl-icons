...
const PermdeviceinfoIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e8a5', 16))}
    </Text>
  );
};

export default PermdeviceinfoIcon;
