...
const Exposureminus2Icon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e3cc', 16))}
    </Text>
  );
};

export default Exposureminus2Icon;
