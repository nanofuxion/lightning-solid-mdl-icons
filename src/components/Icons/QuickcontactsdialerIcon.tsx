...
const QuickcontactsdialerIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e0cf', 16))}
    </Text>
  );
};

export default QuickcontactsdialerIcon;
