...
const QuickcontactsmailIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e0d0', 16))}
    </Text>
  );
};

export default QuickcontactsmailIcon;
