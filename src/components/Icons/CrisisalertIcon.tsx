...
const CrisisalertIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('ebe9', 16))}
    </Text>
  );
};

export default CrisisalertIcon;
