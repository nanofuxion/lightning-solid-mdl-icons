...
const SettingsdisplayIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e8bd', 16))}
    </Text>
  );
};

export default SettingsdisplayIcon;
