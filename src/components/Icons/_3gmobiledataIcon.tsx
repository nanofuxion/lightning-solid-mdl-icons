...
const _3gmobiledataIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('efd0', 16))}
    </Text>
  );
};

export default _3gmobiledataIcon;
