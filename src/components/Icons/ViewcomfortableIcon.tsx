...
const ViewcomfortableIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e42a', 16))}
    </Text>
  );
};

export default ViewcomfortableIcon;
