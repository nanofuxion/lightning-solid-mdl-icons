...
const AirplanemodeonIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e195', 16))}
    </Text>
  );
};

export default AirplanemodeonIcon;
