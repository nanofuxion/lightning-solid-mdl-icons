...
const LocationhistoryIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e55a', 16))}
    </Text>
  );
};

export default LocationhistoryIcon;
