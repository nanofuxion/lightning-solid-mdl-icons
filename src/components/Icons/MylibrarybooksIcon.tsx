...
const MylibrarybooksIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e02f', 16))}
    </Text>
  );
};

export default MylibrarybooksIcon;
