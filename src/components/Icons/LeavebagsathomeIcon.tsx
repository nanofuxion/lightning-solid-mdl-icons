...
const LeavebagsathomeIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('f23b', 16))}
    </Text>
  );
};

export default LeavebagsathomeIcon;
