...
const _4gplusmobiledataIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('efd3', 16))}
    </Text>
  );
};

export default _4gplusmobiledataIcon;
