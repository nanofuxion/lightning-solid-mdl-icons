...
const DirectionstrainIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e534', 16))}
    </Text>
  );
};

export default DirectionstrainIcon;
