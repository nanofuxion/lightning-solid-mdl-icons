...
const InvertcolorsonIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e891', 16))}
    </Text>
  );
};

export default InvertcolorsonIcon;
