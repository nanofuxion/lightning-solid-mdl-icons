...
const NowwidgetsIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e75e', 16))}
    </Text>
  );
};

export default NowwidgetsIcon;
