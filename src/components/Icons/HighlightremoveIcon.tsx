...
const HighlightremoveIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e888', 16))}
    </Text>
  );
};

export default HighlightremoveIcon;
