...
const SystemupdatetvIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e8d7', 16))}
    </Text>
  );
};

export default SystemupdatetvIcon;
