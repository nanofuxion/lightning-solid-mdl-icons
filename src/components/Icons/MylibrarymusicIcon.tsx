...
const MylibrarymusicIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e030', 16))}
    </Text>
  );
};

export default MylibrarymusicIcon;
