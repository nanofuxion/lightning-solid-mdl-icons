...
const LocalattractionIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e53f', 16))}
    </Text>
  );
};

export default LocalattractionIcon;
