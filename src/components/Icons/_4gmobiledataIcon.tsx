...
const _4gmobiledataIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('efd2', 16))}
    </Text>
  );
};

export default _4gmobiledataIcon;
