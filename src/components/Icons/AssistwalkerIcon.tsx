...
const AssistwalkerIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('f8d5', 16))}
    </Text>
  );
};

export default AssistwalkerIcon;
