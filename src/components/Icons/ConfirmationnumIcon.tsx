...
const ConfirmationnumIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e638', 16))}
    </Text>
  );
};

export default ConfirmationnumIcon;
