...
const MultitrackaudioIcon = ({ color, size, focusedSize, focusedColor, type = FontTypes.regular }: Props) => {
  ...
  return (
    <Text style={iconStyle}>
      {String.fromCharCode(parseInt('e1b8', 16))}
    </Text>
  );
};

export default MultitrackaudioIcon;
